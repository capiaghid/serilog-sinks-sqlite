...
namespace Serilog.Sinks.SQLite.Sinks.Extensions
{
    internal static class LogEventExtensions
    {
        ...
        private static dynamic ConvertToDictionary(LogEvent logEvent, bool storeTimestampInUtc, IFormatProvider formatProvider = null)
        {
        ...
        private static object Simplify(LogEventPropertyValue data)
        {
            ...
            if (data is DictionaryValue dictValue)
            {
                ...
                foreach (KeyValuePair<ScalarValue, LogEventPropertyValue> item in dictValue.Elements)
                {
